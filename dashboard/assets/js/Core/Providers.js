Core_Providers = Core.extend({
 ...
 getData : function(){
    ...
    window.DataChooser = $('.sidepanel .panel-body').DataChooser({
        ...
        source:'http://ws.iclicauditor.com/providers/all',
        params:{tenant:that.options.tenant},
        prepend:true,
        primary:'_id',
        template: ' <div class="row-{{role}}"> <div class="pull-left"> <div class="subtext ">{{key}}</div> </div>  <div class="clear fix"></div> </div>',
