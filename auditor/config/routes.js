...
module.exports.routes = {
  ...
  '/campaings/upload-locations': {
      controller:'campaingsController',
      action:'uploadlocations'
  },
  '/campaings/save-art': {
      controller:'campaingsController',
      action:'save_art'
  },
  '/locations/state-table': {
  ...
  '/locations/last-status': {
      controller:'locationsController',
      action:'laststatus'
  },

  '/locations/get-status': {
      controller:'locationsController',
      action:'getstatus'
  },

  '/locations/status-delete/:uuid': {
      controller:'locationsController',
      action:'statusdelete'
  },
  '/mobile/status-delete/:uuid': {
      controller:'locationsController',
      action:'statusdelete'
  },
  ...
  '/dashboard/last-status': {
      controller:'dashboardController',
      action:'last_status'
  },

  '/providers/locations-table': {
